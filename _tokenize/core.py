...
from _util.trie import Trie, dict_trie
...
#         from _tokenize import clause_tokenize
...
#     """
#     from _tokenize.crfcls import segment
...
def word_tokenize(
    ...
    **Options for engine**
    ...
    Tokenize with default and custom dictionary::
        ...
        from _tokenize import dict_trie
    ...
    if engine == "newmm" or engine == "onecut":
        from _tokenize.newmm import segment
    ...
    # elif engine == "attacut":
    #     from _tokenize.attacut import segment

    #     segments = segment(text)
    elif engine == "longest":
        from _tokenize.longest import segment

        segments = segment(text, custom_dict)
    # elif engine == "mm" or engine == "multi_cut":
    #     from _tokenize.multi_cut import segment

    #     segments = segment(text, custom_dict)
    # elif engine == "deepcut":  # deepcut can optionally use dictionary
    #     from _tokenize.deepcut import segment
    ...
    #         segments = segment(text)
        ...
        from _tokenize.pyicu import segment

        segments = segment(text)
    # elif engine == "nercut":
    #     from _tokenize.nercut import segment

    #     segments = segment(text)
    # elif engine == "sefr_cut":
    #     from _tokenize.sefr_cut import segment

    #     segments = segment(text)
    # elif engine == "tltk":
    #     from _tokenize.tltk import segment

    #     segments = segment(text)
    # elif engine == "oskut":
    #     from _tokenize.oskut import segment

    #     segments = segment(text)
    # elif engine == "nlpo3":
    #     from _tokenize.nlpo3 import segment
...
#         from _tokenize import sent_tokenize
...
#     if engine == "crfcut":
#         from _tokenize.crfcut import segment
...
#         segments = text.split()
#     elif engine == "tltk":
#         from _tokenize.tltk import sent_tokenize as segment
...
#         from _tokenize import subword_tokenize
...
#     if engine == "tcc":
#         from _tokenize.tcc import segment
#     elif engine == "etcc":
#         from _tokenize.etcc import segment
...
#             )
#     elif engine == "ssg":
#         from _tokenize.ssg import segment
#     elif engine == "tltk":
#         from _tokenize.tltk import syllable_tokenize as segment
#     else:
#         raise ValueError(
#             f"""Tokenizer \"{engine}\" not found.
#             It might be a typo; if not, please consult our document."""
...
#         from _tokenize import syllable_tokenize
